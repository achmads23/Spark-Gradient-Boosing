 ...
 * @author achmad
 */
public class Create_Negative_Images {
    
    public Create_Negative_Images() throws IOException{
        String Path = "E:\\Teknik Informatika 2012\\Tugas Akhir\\Dataset\\raw_images";
        ...
        for (int i = 0; i < listOfImage.length; i++) {
            ...
            for(int j = 0 ; j< 100 ; j++){
                ...
                if(_height > 0 && _width > 0 &&_width < 100 && _height < 100){
                    ...
                    count++;
                    img = Scalr.resize(img, Scalr.Method.SPEED,Scalr.Mode.FIT_EXACT, 50,50, OP_ANTIALIAS);
    ...
    public static void main(String[] args) throws Exception{
        Create_Negative_Images obj = new Create_Negative_Images();
    }
}
